package com.elTohamy.flushy.data.remote.dto.players.topYellowCards

import com.google.gson.annotations.SerializedName

data class TopYellowCards(

	@field:SerializedName("response")
	val response: List<TopYellowResponseItem?>? = null,
...
data class TopYellowResponseItem(
