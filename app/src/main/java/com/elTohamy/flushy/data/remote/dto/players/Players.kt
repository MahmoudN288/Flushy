package com.elTohamy.flushy.data.remote.dto.players
...
data class Players(
	...
	val response: List<PlayerInfoResponseItem?>? = null,
...
data class PlayerInfoResponseItem(
...
data class Parameters(
	...
	@field:SerializedName("id")
	val id: Int? = null, //id=id (Id of the player)

	@field:SerializedName("league")
	val league: Int? = null, //league=id

	@field:SerializedName("search")
	val search: String? = null, // >= 4 Characters ex. search=belli (For Jude Bellingham in Real Madrid id=129718)
