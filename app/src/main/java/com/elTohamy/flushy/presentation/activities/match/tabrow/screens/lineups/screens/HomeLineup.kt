...
fun HomeBench(
    ...
    val managerHomeName = lineupsResponseItemList[0]!!.coach!!.name
    val managerHomePhoto = lineupsResponseItemList[0]!!.coach!!.photo
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(15.dp),
        ...
        Card(
            ...
            Column(
                ...
                lineupsResponseItemList[0]!!.substitutes!!
                    .forEach { subItem->
                        playersStatsList[0]!!.players!!
                            .forEach { playerItem->
                                if (
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                lineupsResponseItem[0]!!.startXI?.forEach { startingPlayersList ->
                    if ((startingPlayersList!!.player!!.grid as? String)!!.substring(0, 1) == "1") {
                        playersStatsList[0]!!.players!!.forEach { matchPlayerItem ->
            ...
            Row(
                ...
                if (
                    lineupsResponseItem[0]!!.formation == "4-4-2" || lineupsResponseItem[0]!!.formation == "4-3-3" ||
                    lineupsResponseItem[0]!!.formation == "3-5-2" || lineupsResponseItem[0]!!.formation == "5-3-2" ||
                    lineupsResponseItem[0]!!.formation == "3-4-3" || lineupsResponseItem[0]!!.formation == "4-4-1-1" ||
                    lineupsResponseItem[0]!!.formation == "4-3-2-1" || lineupsResponseItem[0]!!.formation == "4-5-1" ||
                    lineupsResponseItem[0]!!.formation == "5-4-1"
            ...
            Row(
                ...
                horizontalArrangement =
                if (
                    lineupsResponseItem[0]!!.formation == "4-1-4-1" || lineupsResponseItem[0]!!.formation == "4-3-3" ||
                    lineupsResponseItem[0]!!.formation == "4-2-4" || lineupsResponseItem[0]!!.formation == "3-4-3"
                ) Arrangement.SpaceBetween else Arrangement.Center
            ) {
                lineupsResponseItem[0]!!.startXI?.forEach { startingPlayersList ->
            ...
            if (lineupsResponseItem[0]?.formation?.length!! >= 7) {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 1.dp)
            ...
            if (lineupsResponseItem[0]!!.formation!!.length >= 9) {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(horizontal = 1.dp)
