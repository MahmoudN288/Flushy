package com.elTohamy.flushy.presentation.activities.players
...
import com.elTohamy.flushy.presentation.activities.players.tabRow.PlayerTabScreen
...
class PlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val playerId = extras?.getInt("playerId")
            ...
            CompositionLocalProvider(LocalTheme provides useDarkColors, LocalLayoutDirection provides local) {
                FlushyTheme(darkTheme = LocalTheme.current.isDark) {
                    ...
                    Surface(
                        ...
                        PlayerTabScreen(
                            id = playerId!!, season = currentSeason!!
                        )
                    }
                }
            }
