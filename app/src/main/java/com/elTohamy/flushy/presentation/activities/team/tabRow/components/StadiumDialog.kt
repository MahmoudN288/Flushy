package com.elTohamy.flushy.presentation.activities.team.tabRow.components
...
fun FetchStadiumInfo(
    ...
    LaunchedEffect(key1 = Unit) {
        if (!teamViewModel.isVenuesByIdInitialized.value) {
            teamViewModel.getVenuesById(teamViewModel.venueId.value)
            teamViewModel.isVenuesByIdInitialized.value = true
        }
    }
    when (val state = teamViewModel.venuesByIdState.collectAsState().value) {
